...
class Main:
	...
	def getVideos( self ) :
		...
		# Get HTML page...
		#
		url           = "http://www.gametrailers.com/feeds/line_listing_results/video_hub/6bc9c4b7-0147-4861-9dac-7bfe8db9a141/?sortBy=most_recent&category=Preview&currentPage=%d" % ( self.current_page )
